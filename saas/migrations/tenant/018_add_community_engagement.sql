-- Epic F: Community & Engagement for Tenant Databases
-- Migration: 018_add_community_engagement.sql
...
-- Achievement Shares table (commented out - requires achievements table which doesn't exist in tenant migrations yet)
...
-- Groups table (must be created before group_challenges)
