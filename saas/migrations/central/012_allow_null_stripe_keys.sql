-- Migration: Allow NULL values for Stripe keys in platform_payment_settings
-- Purpose: Enable admins to delete/disable Stripe payment provider
-- Date: 2026-03-02
...
COMMENT ON COLUMN platform_payment_settings.stripe_publishable_key IS 
  'Stripe publishable key. NULL means Stripe is disabled.';

COMMENT ON COLUMN platform_payment_settings.stripe_secret_key IS 
