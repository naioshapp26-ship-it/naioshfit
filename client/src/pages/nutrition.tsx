...
import { dateStringForToday, formatInAppTz, formatInAppTzWithOptions, parseDateStringInAppTz } from '@/lib/timezone';
          ...
          <Dialog open={isAddMealOpen} onOpenChange={handleDialogOpenChange}>
            ...
            <DialogContent className="sm:max-w-[600px] max-w-[95vw] max-h-[90vh] overflow-y-auto w-full mx-4">
              ...
              <MealForm 
                ...
                defaultValues={editingMeal ? { ...editingMeal, fiber: editingMeal.fiber || 0, foodItems: editingMeal.foodItems || [] } : { date: selectedDate }}
