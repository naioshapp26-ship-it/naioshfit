...
import { formatFoodPreferences } from "@/lib/food-preferences";
...
export default function Profile() {
  ...
  const isViewingOtherUser = userId != null && currentViewer?.id != null && userId !== currentViewer.id;
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl relative min-h-screen">
      ...
      <div className="mb-8">
        ...
        {isViewingOtherUser && (
          <p className="text-sm text-amber-700 mt-2">{t('profileReadOnlyOtherUser')}</p>
        )}
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div
                  id="preferredCarbs"
                  className="rounded-md border border-input bg-muted/40 px-3 py-2 text-sm min-h-10"
                >
                  {formatFoodPreferences(formData.preferredCarbs, language) || '—'}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div
                  ...
                  className="rounded-md border border-input bg-muted/40 px-3 py-2 text-sm min-h-10"
                >
                  {formatFoodPreferences(formData.preferredProteins, language) || '—'}
                </div>
              </div>
              <div>
                ...
                <div
                  ...
                  className="rounded-md border border-input bg-muted/40 px-3 py-2 text-sm min-h-10"
                >
                  {formatFoodPreferences(formData.preferredLegumes, language) || '—'}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div
                  ...
                  className="rounded-md border border-input bg-muted/40 px-3 py-2 text-sm min-h-10"
                >
                  {formatFoodPreferences(formData.preferredVegetables, language) || '—'}
                </div>
              </div>
              <div>
                ...
                <div
                  ...
                  className="rounded-md border border-input bg-muted/40 px-3 py-2 text-sm min-h-10"
                >
                  {formatFoodPreferences(formData.preferredDairy, language) || '—'}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div
                  ...
                  className="rounded-md border border-input bg-muted/40 px-3 py-2 text-sm min-h-10"
                >
                  {formatFoodPreferences(formData.preferredFats, language) || '—'}
                </div>
              </div>
              <div>
                ...
                <div
                  ...
                  className="rounded-md border border-input bg-muted/40 px-3 py-2 text-sm min-h-10"
                >
                  {formatFoodPreferences(formData.preferredFruits, language) || '—'}
                </div>
              </div>
            </div>
