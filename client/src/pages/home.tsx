...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
      {/* Hero Section */}
      {showHeroSection && (
      <section id="top" className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-background pt-32 md:pt-28 pb-14">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            ...
            >
              ...
              <motion.h1
                className="text-[clamp(1.9rem,8.5vw,4.6rem)] font-bold text-white mb-6 leading-tight"
                variants={itemVariants}
              >
                {heroTitle ? (
              ...
              <motion.div className="flex flex-col gap-4" variants={itemVariants}>
                <div className={isRTL ? "flex flex-col sm:flex-row-reverse sm:flex-wrap gap-4 sm:justify-end" : "flex flex-col sm:flex-row sm:flex-wrap gap-4"}>
                  {isAuthenticated ? (
                    <Link href="/courses">
                      <Button size="lg" className="w-full sm:w-auto justify-center text-lg px-8 py-6 rounded-full">
                        {t('courses')} {isRTL ? <ArrowRight className="mr-2 h-5 w-5 rotate-180" /> : <ArrowRight className="ml-2 h-5 w-5" />}
                      </Button>
                    </Link>
                  ) : (
                    <Link href="/signup">
                      <Button size="lg" className="w-full sm:w-auto justify-center text-lg px-8 py-6 rounded-full animate-pulse">
                  ...
                  {!isTenantSubdomain && (
                    <a href="https://www.naioshfit.com/saas">
                      <Button
                        variant="secondary"
                        size="lg"
                        className="w-full sm:w-auto justify-center text-lg px-8 py-6 rounded-full"
                      >
                        {t('becomeTenant')}
                      </Button>
                    </a>
                  ...
                  {isAuthenticated ? (
                    <Link href="/dashboard">
                      <Button variant="outline" size="lg" className="w-full sm:w-auto justify-center text-lg px-8 py-6 rounded-full bg-black/30 backdrop-blur-sm border-white/20 text-white hover:bg-black/40">
                        {t('dashboard')}
                      </Button>
                    </Link>
                  ) : (
                ...
                {!isAuthenticated && (
                  <div className={isRTL ? "flex justify-end" : "flex justify-start"}>
                    <Button
                      size="lg"
                      className="w-full sm:w-auto justify-center text-lg px-8 py-6 rounded-full bg-red-900 hover:bg-red-800 text-white"
