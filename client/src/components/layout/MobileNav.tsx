...
export const MobileNav = () => {
  ...
  return (
    <>
      {/* Mobile Header */}
      <header className={cn(
        "lg:hidden sticky top-0 z-40 bg-white/95 backdrop-blur shadow-sm py-3 px-4 flex items-center justify-between min-h-[64px] safe-area-padding",
        ...
        <div className={cn("flex items-center", isRTL && "flex-row-reverse")}>
          ...
          <h1 className="text-xl font-semibold flex items-center gap-2">
            ...
            />
            <span className="text-primary font-bold">NaioshFit</span>
          </h1>
        </div>
        <div className={cn("flex items-center gap-2", isRTL && "flex-row-reverse")}>
          ...
          <button className={cn("text-gray-700", isRTL ? "ml-3" : "mr-3")}>
