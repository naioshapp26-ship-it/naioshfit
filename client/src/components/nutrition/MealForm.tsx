...
const MealForm: React.FC<MealFormProps> = ({
  ...
  const saveMeal = async () => {
    ...
    const formattedData = {
      ...
      date: currentValues.date instanceof Date ? currentValues.date.toISOString() : 
            // Make sure the date is in the correct format
            typeof currentValues.date === 'string' ? new Date(currentValues.date).toISOString() : new Date().toISOString(),
            ...
            <div className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => {
                  ...
                  const toDatetimeLocal = (isoString: string | Date) => {
