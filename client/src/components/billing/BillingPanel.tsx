      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            ...
            size="lg"
            disabled={!selectedPackageData || createOrderMutation.isPending || (paymentProvider === 'stripe' && !stripeConfigured) || (paymentProvider === 'paypal' && !paypalConfigured) || (paymentProvider === 'paymob' && !paymobConfigured)}
            onClick={startCheckout}
          >
            {createOrderMutation.isPending ? t('processingPayment') : t('startCheckout')}
          </Button>
        </CardContent>
      </Card>
