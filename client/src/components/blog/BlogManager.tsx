        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">{t("blogRequiredFields")}</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label>{t("blogTitle")} <span className="text-red-500">*</span></Label>
                  <Input
                    value={form.title}
                ...
                <div className="space-y-2">
                  <Label>{t("blogTitleAr")} <span className="text-red-500">*</span></Label>
                  <Input
                    value={form.titleAr}
              ...
              <Tabs defaultValue="en" className="space-y-4">
                ...
                <TabsContent value="en" className="space-y-2">
                  <Label>{t("blogContent")} <span className="text-red-500">*</span></Label>
                  <BlogEditor
                    value={form.content}
                ...
                <TabsContent value="ar" className="space-y-2" dir="rtl">
                  <Label>{t("blogContentAr")} <span className="text-red-500">*</span></Label>
                  <BlogEditor
