...
import { FoodPreferenceCheckboxGroup } from '@/components/nutrition/FoodPreferenceCheckboxGroup';
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FoodPreferenceCheckboxGroup control={form.control} name="preferredCarbs" category="carbs" />
                <FoodPreferenceCheckboxGroup control={form.control} name="preferredProteins" category="proteins" />
                <FoodPreferenceCheckboxGroup control={form.control} name="preferredLegumes" category="legumes" />
                <FoodPreferenceCheckboxGroup control={form.control} name="preferredVegetables" category="vegetables" />
                <FoodPreferenceCheckboxGroup control={form.control} name="preferredDairy" category="dairy" />
                <FoodPreferenceCheckboxGroup control={form.control} name="preferredFats" category="fats" />
                <FoodPreferenceCheckboxGroup control={form.control} name="preferredFruits" category="fruits" />
              </div>
            </div>
